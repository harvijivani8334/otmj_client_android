...
class PostJobListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView: View =
            LayoutInflater.from(parent.context).inflate(R.layout.row_post_job_item, parent, false)
    ...
    private inner class ItemViewHolder(itemView: View) :
        ...
        var binding: RowPostJobItemBinding = DataBindingUtil.bind(itemView)!!
